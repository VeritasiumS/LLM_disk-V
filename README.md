...
The LED lights, buttons, and photoresistor, are connected to the breadboard. The photoresistor connects to A0 with a 10k resistor. The LED are wired  with 220 ohm resistors. The selection buttons are connected to digital pin 2, 3, 4 with 10k ohm resistors each.
